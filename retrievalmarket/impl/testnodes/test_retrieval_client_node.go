...
type TestRetrievalClientNode struct {
	...
	createPaymentVoucherRecorder      func(voucher *flowch.SignedVoucher)
...
type TestRetrievalClientNodeParams struct {
	...
	VoucherError                error
	AllocateLaneRecorder        func(address.Address)
	PaymentVoucherRecorder      func(voucher *flowch.SignedVoucher)
...
func (trcn *TestRetrievalClientNode) CreatePaymentVoucher(ctx context.Context, paymentChannel address.Address, amount abi.TokenAmount, lane uint64, tok shared.TipSetToken) (*flowch.SignedVoucher, error) {
